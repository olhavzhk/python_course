...
def load_phonebook(phonebook_name):
    if os.path.exists(f"{phonebook_name}.json"):
        ...
        raise FileNotFoundError("Phonebook not found. Please create a new phonebook_sub_app.")
...
def add_entry(phonebook):
    print("Add a new entry to the phonebook_sub_app:")
...
def main():
    phonebook_name = input("Enter the name of the phonebook_sub_app: ")
    try:
